...
List.prototype.fetch = function(req, res, context) {
      ...
      var searchAttributes =
        ...
        for (let str of searchString) {
          ...
          searchAttributes.forEach(function(attr) {
            ...
            console.log("Search opertor:", searchOperator);

            let item = {}
            if (queries.length > 1) {
              criteria[attr] = {[Sequelize.Op.or]: queries};
            } else {
              criteria[attr] = queries[0];
            }
        ...
        console.log("criteria:", util.inspect(criteria, {showHidden: false, depth: null}))
  ...
  console.log("options:", util.inspect(options, {showHidden: false, depth: null}))
